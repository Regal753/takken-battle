...
assert.match(index, /manifest\.webmanifest\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /pwa-runtime\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(text("service-worker.js"), /const VERSION = "20260826-quality-v39-4-68744e2bbe74"/);
assert.match(manifest, /pwa-icon-192\.svg\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(manifest, /pwa-icon-512\.svg\?v=20260826-quality-v39-4-68744e2bbe74/);
...
assert.match(index, /styles\.css\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /subject-sprint-bank\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /pass-readiness\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /exam-current-year-2026\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /official-topic-map\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /business-mastery\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /business-knock\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /business-pace\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /business-fullscore-supplement\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /business-fullscore-bank\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /guarantee-association-drill\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /practical-question-bank\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /calculation-drill\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /app\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /save-store\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /official-exam-data\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /official-law-baseline\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
assert.match(index, /state-sync\.js\?v=20260826-quality-v39-4-68744e2bbe74/);
...
assert.match(pagesWorkflow, /20260826-quality-v39-4-68744e2bbe74/);
