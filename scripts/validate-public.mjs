...
assert.match(index, /styles\.css\?v=20260811-practical-review-ux-v22-1/);
assert.match(index, /practical-question-bank\.js\?v=20260811-practical-review-ux-v22-1/);
assert.match(index, /calculation-drill\.js\?v=20260811-practical-review-ux-v22-1/);
assert.match(index, /app\.js\?v=20260811-practical-review-ux-v22-1/);
assert.match(index, /save-store\.js\?v=20260811-practical-review-ux-v22-1/);
assert.match(index, /official-exam-data\.js\?v=20260811-practical-review-ux-v22-1/);
...
assert.match(pagesWorkflow, /20260811-practical-review-ux-v22-1/);
