...
assert.match(index, /manifest\.webmanifest\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /pwa-runtime\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(text("service-worker.js"), /const VERSION = "20260912-restrictions-v58-2941b71f7fc3"/);
assert.match(manifest, /pwa-icon-192\.svg\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(manifest, /pwa-icon-512\.svg\?v=20260912-restrictions-v58-2941b71f7fc3/);
...
assert.match(index, /styles\.css\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /reiwa-exam\.css\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /current-law-source-ledger\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /reiwa-exam-bank\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /reiwa-question-view\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.ok(
...
assert.match(index, /restrictions-supplement-bank\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /subject-sprint-bank\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.ok(
...
assert.match(index, /pass-readiness\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /exam-current-year-2026\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /official-topic-map\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /business-mastery\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /business-knock\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /business-pace\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /business-fullscore-supplement\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /business-fullscore-bank\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /guarantee-association-drill\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /practical-question-bank\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /calculation-drill\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /app\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /save-store\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /official-exam-data\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /official-law-baseline\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
assert.match(index, /state-sync\.js\?v=20260912-restrictions-v58-2941b71f7fc3/);
...
assert.match(pagesWorkflow, /20260912-restrictions-v58-2941b71f7fc3/);
