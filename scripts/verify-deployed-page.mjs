...
const expectedVersion = process.argv[3] || "20260910-restriction-precision-v50-364ed7a15787";
...
for (let attempt = 1; attempt <= attempts; attempt += 1) {
  try {
    ...
    assert.match(appCode, /const STATE_SCHEMA_VERSION = 13/, "save schema v13 missing");
