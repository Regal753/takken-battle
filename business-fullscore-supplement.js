  ...
  const rawAnchors = [
    ...
    },
    {
      ...
      statements: [
        ...
        "2025年4月1日の見直しにより、免許申請等の添付書類が再編され、免許申請者（法人では役員）及び政令使用人の氏名、住所、電話番号その他の連絡先を記載する書面が追加された。",
      ...
      reasons: [
        ...
        "令和6年国土交通省令70号後の施行規則1条の2第1項8号により、免許申請者等の氏名・住所・電話番号その他の連絡先を記載する書面が追加された。専任宅建士等の略歴書には住所・電話番号・生年月日の欄が残る。",
    ...
    },
    {
      ...
      reasons: [
        ...
        "法31条の3第3項により、既存事務所が法定数に抵触するに至った時から2週間以内に必要な措置を執る。"
      ],
      sourceUrl: "https://laws.e-gov.go.jp/law/327AC1000000176",
