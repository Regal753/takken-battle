...
assert.match(index, /styles\.css\?v=20260730-official-drill-v10/);
assert.match(index, /app\.js\?v=20260730-official-drill-v10/);
...
assert.match(pagesWorkflow, /20260730-official-drill-v10/);
