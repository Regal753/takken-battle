...
(() => {
  ...
  const URLS = Object.freeze({
    ...
    businessGuaranteeRule: "https://laws.e-gov.go.jp/law/332M50004010001?occasion_date=20260401"
  });
  ...
  const A = URLS.act, D = URLS.decree, R = URLS.regulation, J = URLS.jointRule, B = URLS.businessGuaranteeRule;
  ...
  const Q = [
    ...
    make("ga004", "単一選択", "保証協会が、第64条の9第1項又は第2項の弁済業務保証金分担金を社員から受領し、その相当額を弁済業務保証金として供託する相手はどれか。", 3, [["社員", "供託の相手は社員ではない。", `${L("64条の7")}`, A], ["被害を受けた取引相手", "還付前に取引相手へ直接交付する制度ではない。", `${L("64条の7")}`, A], ["国土交通大臣", "供託先は大臣ではない。", `${L("64条の7")}`, A], ["供託所", "保証協会は第64条の9第1項又は第2項の分担金を受領すると、その相当額を供託所に供託する。", `${L("64条の7")}`, A]], "通常の分担金の受領者と、その相当額の供託先を分ける。", "特別弁済業務保証金分担金や、協会が消費者に払う流れと混同する。", "64条の9①②の分担金：社員→協会→供託所。", ["counterparty", "principle-exception"]),
    ...
    make("ga007", "単一選択", "保証協会が、第64条の9第1項又は第2項の弁済業務保証金分担金を社員から受領したとき、その相当額を供託すべき期限はいつか。", 2, [["受領前日まで", "受領前に供託することはできない。", `${L("64条の7")}`, A], ["受領日から2週間以内", "2週間は社員の新設事務所分の納付期限。", `${L("64条の9")}`, A], ["受領日から1週間以内", "保証協会は第64条の9第1項又は第2項の分担金を受領した日から1週間以内に、その相当額を供託する。", `${L("64条の7")}`, A], ["受領日から1か月以内", "1か月は特別弁済業務保証金分担金の社員側の納付期限であり、この供託期限ではない。", `${L("64条の7")}・${L("64条の12")}`, A]], "社員の新設2週と、協会が通常分担金を受領した後の1週は別。", "特別分担金や『新設2週』を協会の供託期限に流用する。", "64条の9①②の分担金を協会が受領→1週で供託。", ["timing", "counterparty", "principle-exception"]),
    ...
    make("ga009", "単一選択", "保証協会の社員と取引した者が弁済業務保証金から還付を受けられる者として正しいものはどれか。", 1, [["宅建業者である取引相手だけ", "宅建業者は還付請求権者から除かれる。", `${L("64条の8")}`, A], ["弁済業務開始日以後に、宅建業者でない取引相手が請求する場合は、社員となる前の取引による債権者も含む", "弁済業務開始日以後の還付請求では、宅建業者以外の者で、社員となる前の取引から生じた債権者も含まれる。", `${L("64条の8")}`, A], ["社員となった後の取引に限る", "弁済業務開始日以後の還付請求でも、加入前の取引による債権者を排除しない。", `${L("64条の8")}`, A], ["保証協会の社員だけ", "社員自身のための還付制度ではない。", `${L("64条の8")}`, A]], "消費者保護。弁済業務開始日以後、相手が宅建業者なら除外、加入前債権も入る。", "加入前取引は対象外と思い込む。", "開始日以後＋非業者＋加入前債権も可。", ["subject", "transaction-type", "timing"]),
    make("ga010", "計算問題", "弁済業務開始日以後、宅地建物取引業者でない取引相手について、既に認証された還付額0円・還付充当金0円で、主たる事務所1、従たる事務所2の保証協会社員から還付を受けられる上限はいくらか。", 2, [["120万円", "分担金額（60+30×2）を上限とするわけではない。", `${L("64条の8")}`, A], ["1,500万円", "従たる事務所1か所分が不足する。", `${L("25条1項")}`, A], ["2,000万円", "弁済業務開始日以後、非宅建業者が請求し、既認証額・還付充当金が0円の前提では、営業保証金を供託していたなら必要な額1,000万円+500万円×2が還付上限。", `${L("64条の8")}`, A], ["無制限", "還付には営業保証金相当額という上限がある。", `${L("64条の8")}`, A]], "還付上限は60・30ではなく、営業保証金なら必要だった1000・500。開始日以後か、請求者が非宅建業者か、認証済額等の控除があるかも読む。", "分担金額がそのまま被害者上限だと誤解する。", "開始日以後の非宅建業者上限=営業保証金換算（既認証0・充当0）。", ["number", "calculation", "subject", "timing"]),
    make("ga011", "手続順序", "第64条の8第1項の権利を有する者が、弁済業務保証金から還付を受けるための最初の必須手続として正しいものはどれか。", 0, [["保証協会から認証を受ける", "権利者が還付を受けようとするときは、まず保証協会の認証を受ける。", `${L("64条の8")}`, A], ["供託所に直接還付請求する", "認証を経ずに供託所へ直接請求する順序ではない。", `${L("64条の8")}`, A], ["社員に分担金の返還を請求する", "被害者の還付手続ではない。", `${L("64条の8")}`, A], ["免許権者の許可を受ける", "免許権者の許可は要件ではない。", `${L("64条の8")}`, A]], "認証→供託所。入口は保証協会。", "営業保証金の還付と同じく供託所直行と誤る。", "64条の8の権利者は還付前に認証。", ["procedure", "counterparty", "subject"]),
    ...
    make("ga016", "事例問題", "弁済業務開始日以後、指定取消し・解散の特則ではない通常の理由で保証協会の社員資格を失った宅建業者が営業を続けるため、営業保証金を供託すべき期限はいつか。", 2, [["資格喪失前日まで", "資格喪失前に営業保証金の供託義務が生じるわけではない。", `${L("64条の15")}`, A], ["資格喪失から2週間以内", "弁済業務開始日以後の通常の地位喪失は2週間ではなく1週間。", `${L("64条の15")}`, A], ["資格喪失から1週間以内", "弁済業務開始日以後、通常の理由で社員資格を失った者は1週間以内に営業保証金を供託する。指定取消し・解散は別特則。", `${L("64条の15")}`, A], ["資格喪失から1か月以内", "1か月ではない。", `${L("64条の15")}`, A]], "開始日以後の通常資格喪失→営業保証金1週。指定取消し・解散は公示後2週の特則。", "開始日前との区別や、新設事務所2週・取消し解散特則を混同する。", "開始日以後の通常喪失=1週、取消し・解散=公示後2週。", ["timing", "effect", "principle-exception"]),
    ...
    make("ga020", "単一選択", "弁済業務開始日以後の通常の地位喪失（指定取消し・解散の特則ではない）を前提に、次の期限対応のうち、すべて正しく対応しているものはどれか。", 2, [["加入=加入後2週／新設=1週／協会受領=2週／資格喪失=1週", "加入は加入前、新設は2週、協会受領は1週なので誤り。", `${L("64条の9")}・${L("64条の7")}・${L("64条の15")}`, A], ["加入=加入前／新設=2週／協会受領=1週／資格喪失=2週", "弁済業務開始日以後の通常の資格喪失後の営業保証金は1週であり、最後が誤り。", `${L("64条の9")}・${L("64条の7")}・${L("64条の15")}`, A], ["加入=加入前／新設=2週／協会受領=1週／資格喪失=1週", "加入前・新設2週・協会受領1週・開始日以後の通常資格喪失1週の対応が正しい。", `${L("64条の9")}・${L("64条の7")}・${L("64条の15")}`, A], ["加入=加入前／新設=1か月／協会受領=1週／資格喪失=1週", "新設事務所分は1か月ではなく2週間以内。", `${L("64条の9")}・${L("64条の7")}・${L("64条の15")}`, A]], "期限を孤立暗記せず、当事者と並べて比較する。開始日以後の通常喪失と、指定取消し・解散の特則を分ける。", "開始日前後や、資格喪失後の営業保証金を2週とする特則を混同する。", "開始日以後の通常喪失=1週（取消し・解散は別）。", ["timing", "procedure", "counterparty", "principle-exception"]),
    ...
    make("ga025", "単一選択", "社員の地位喪失後の弁済業務保証金の取戻し・分担金返還について正しいものはどれか。", 3, [["地位喪失と同時に、公告なしで当然に全額を返還する", "地位喪失時の返還は、6か月以上の認証申出公告期間の経過などを待つ。", `${L("64条の11")}`, A], ["公告期間中に認証申出が1件でもあれば、無条件で全額を返還する", "認証や還付充当金に関する債権への弁済を終えずに無条件返還はできない。", `${L("64条の11")}`, A], ["公告期間さえ終われば、協会が元社員に有する債権を無視して返還する", "協会が元社員等に債権を持つ場合は、その弁済完了後に返還する。", `${L("64条の11")}`, A], ["協会が弁済業務保証金を取り戻したときは分担金を返還する。ただし地位喪失時は、6か月以上の認証申出公告期間経過後で、協会の債権等があればその弁済完了後である", "取戻しは協会ができる制度で、実際に取り戻したときは分担金を返還する。地位喪失時の返還時期は公告期間・協会債権・認証済み額に係る還付充当金債権の清算に制約される。", `${L("64条の11")}`, A]], "協会が取り戻したときは返還。ただし地位喪失時の返還は6か月公告期間経過後、協会債権等があれば弁済後。", "取戻しは公告後でなければできず、又は公告終了で当然返ると思い込む。", "取戻しは協会の選択／返還は取戻し後。地位喪失なら公告・債権清算を確認。", ["timing", "procedure", "principle-exception"]),
    ...
    make("ga027", "事例問題", "保証協会の社員でない宅建業者が、事業開始後に従たる事務所を新設した。新設事務所で営業を始める前の説明として正しいものはどれか。", 1, [["追加営業保証金の供託は不要である", "新たな事務所には政令で定める額の営業保証金を追加供託する。", `${L("26条")}`, A], ["追加営業保証金を供託し、供託書写しを添付して届出をした後でなければ営業を開始できない", "26条は追加供託を求め、25条1項・3項から5項を準用するため、供託書写し添付届出後でなければ営業を開始できない。", `${L("26条")}・${L("25条")}`, A], ["新設の日から2週間以内に保証協会へ分担金を納付すればよい", "保証協会の社員ではない者には、保証協会への分担金納付制度はない。", `${L("26条")}・${L("64条の9")}`, A], ["営業開始後にまとめて追加供託すればよい", "追加供託と届出後でなければ営業開始できない。", `${L("26条")}・${L("25条")}`, A]], "非社員の新設事務所=追加営業保証金→写し添付届出→営業開始。", "保証協会社員の新設2週を非社員に流用する。", "非社員の新設=追加供託・届出後に営業。", ["procedure", "timing", "counterparty"]),
    make("ga028", "手続順序", "営業保証金の還付により不足額が生じた宅建業者の補充・届出として正しいものはどれか。", 2, [["還付日から1週間以内に補充し、届出は不要", "補充の起算点は法務省令・国土交通省令で定める日であり、届出も必要である。", `${L("28条")}`, A], ["不足額を補充すれば、届出は次回更新時でよい", "補充供託後は2週間以内に供託書写しを添付して免許権者へ届け出る。", `${L("28条")}`, A], ["法務省令・国土交通省令で定める日から2週間以内に不足額を供託し、供託後2週間以内に供託書写しを添付して免許権者へ届け出る", "補充は指定日から2週間、届出は補充供託後2週間以内。", `${L("28条")}・宅地建物取引業者営業保証金規則 5条`, B], ["保証協会へ還付充当金を納付する", "営業保証金の補充は宅建業者自身が供託する制度である。", `${L("28条")}`, A]], "営業保証金の還付後=補充2週＋届出2週。", "保証協会の還付充当金・補充供託と混同する。", "営業保証金=指定日から補充2週→供託後届出2週。", ["timing", "procedure", "counterparty"]),
    make("ga029", "事例問題", "宅建業者が主たる事務所を移転し、最寄りの供託所が変わった。金銭のみで営業保証金を供託している場合の措置として正しいものはどれか。", 0, [["遅滞なく費用を予納して、従前の供託所に新たな最寄り供託所への保管替えを請求する", "金銭のみなら、遅滞なく費用を予納して保管替えを請求する。", `${L("29条")}`, A], ["遅滞なく新たな最寄り供託所へ必ず新規供託する", "新規供託は金銭のみ以外の場合である。", `${L("29条")}`, A], ["免許権者へ届出だけすれば足りる", "最寄り供託所変更時は保管替え又は新規供託の措置が必要。", `${L("29条")}`, A], ["営業保証金は移転後も従前の供託所に置いたままでよい", "最寄り供託所が変わる場合の措置が定められている。", `${L("29条")}`, A]], "主事務所移転: 現金のみ=保管替え、その他=新規供託。", "現金か有価証券かを読まず、すべて新規供託にする。", "29条=現金のみ保管替え／その他新規供託。", ["procedure", "principle-exception", "counterparty"]),
    make("ga030", "単一選択", "国土交通大臣の指定の日に、その指定を受けた保証協会の社員であった宅建業者が分担金を納付すべき期限と、不納付の効果として正しいものはどれか。", 1, [["弁済業務開始日までに納付し、未納でも社員資格は維持される", "期限は開始日の1か月前であり、未納なら社員資格を失う。", `${L("64条の9")}`, A], ["弁済業務開始日の1か月前の日までに納付し、未納なら社員資格を失う", "指定日に既存社員だった者は開始日の1か月前までに納付し、不納付なら社員資格を失う。", `${L("64条の9")}`, A], ["社員となろうとする日までに納付し、未納なら直ちに免許が失効する", "これは加入希望者の期限であり、効果も免許失効ではない。", `${L("64条の9")}`, A], ["新設の日から2週間以内に納付し、未納でも資格は維持される", "新設事務所分の期限と効果を取り違えている。", `${L("64条の9")}`, A]], "指定日既存社員=開始1か月前、不納付=資格喪失。", "加入希望者の加入日までと混同する。", "既存社員=開始1か月前＋未納で資格喪失。", ["timing", "effect", "principle-exception"]),
    make("ga031", "単一選択", "保証協会の社員となった宅建業者の営業保証金について正しいものはどれか。", 2, [["社員となった日から直ちに営業保証金を供託する必要がなく、供託済み保証金も直ちに自由に取り戻せる", "供託不要となるのは弁済業務開始日以後であり、取戻しには30条3項準用と営業保証金規則10条の手続がある。", `${L("64条の13")}・${L("64条の14")}・宅地建物取引業者営業保証金規則 10条`, B], ["弁済業務開始日後も営業保証金と分担金を二重に納付しなければならない", "開始日以後の社員は営業保証金を供託する必要がない。", `${L("64条の13")}`, A], ["弁済業務開始日以後は営業保証金の供託を要せず、供託済み保証金は30条3項準用の手続により取り戻すことができる", "開始日以後に供託不要となり、社員となったことを証する免許権者の書面を添付する手続で取り戻せる。6か月公告は不要である。", `${L("64条の13")}・${L("64条の14")}・宅地建物取引業者営業保証金規則 10条`, B], ["保証協会の社員は、弁済業務開始日前でも営業保証金を供託できない", "開始日前は64条の13の免除が及ばない。", `${L("64条の13")}`, A]], "社員でも開始日前は営業保証金あり。開始日後に免除され、免許権者の社員証明書を添付して取戻す。6か月公告は不要。", "加入日と弁済業務開始日を同じにする、又は営業保証金の一般的な公告手続が必要と思い込む。", "開始日後に免除／取戻し=免許権者の社員証明書を添付・6か月公告不要。", ["timing", "principle-exception", "procedure"]),
    make("ga032", "単一選択", "保証協会の社員が、分担金を納付した後に新たに事務所を設置し、その追加分担金を期限までに納付しない場合の効果として正しいものはどれか。", 1, [["追加分担金だけ延滞金を付けて社員資格は維持される", "期限内に納付しない社員は、その地位を失う。", `${L("64条の9")}`, A], ["保証協会の社員資格を失う", "新設事務所分の追加分担金を2週間以内に納付しないと社員資格を失う。", `${L("64条の9")}`, A], ["直ちに免許が失効する", "効果は免許失効ではなく社員資格喪失である。", `${L("64条の9")}`, A], ["保証協会が供託を1週間遅らせるだけである", "社員の追加分担金不納付には資格喪失の効果がある。", `${L("64条の9")}`, A]], "新設後2週で分担金。不納付=社員資格喪失。", "協会の受領後1週供託と、社員の新設後2週不納付を混同する。", "新設=2週納付／未納=資格喪失。", ["timing", "effect", "counterparty"]),
    make("ga033", "単一選択", "営業保証金から債権の弁済を受ける権利を有する者として正しいものはどれか。", 1, [["宅建業者と宅地建物取引業に関し取引をした宅建業者", "宅建業者に該当する者は権利者から除かれる。", `${L("27条")}`, A], ["宅建業者と宅地建物取引業に関し取引をした、宅建業者に該当しない者", "宅建業者と宅建業に関し取引をした非宅建業者は、その取引から生じた債権について弁済を受ける権利を有する。", `${L("27条")}`, A], ["取引の有無を問わない一般債権者", "宅建業に関する取引から生じた債権が必要である。", `${L("27条")}`, A], ["免許権者だけ", "免許権者だけに限定されない。", `${L("27条")}`, A]], "営業保証金も、請求権者は非宅建業者の取引相手。", "保証協会の還付だけ非宅建業者だと思い込む。", "27条=非宅建業者＋宅建業取引の債権。", ["subject", "transaction-type"])
  ];
  ...
  function exactSource(questionId, index) {
    ...
    if (questionId === "ga027") return index === 2 ? [`${L("26条")}・${L("64条の9")}`, A] : [`${L("26条")}・${L("25条")}`, A];
    if (questionId === "ga028") return index === 2 ? [`${L("28条")}・宅地建物取引業者営業保証金規則 5条`, B, freeze([A, B])] : [L("28条"), A];
    if (questionId === "ga029") return [L("29条"), A];
    if (questionId === "ga030") return [L("64条の9"), A];
    if (questionId === "ga031") return [`${L("64条の13")}・${L("64条の14")}・宅地建物取引業者営業保証金規則 10条`, index === 1 || index === 3 ? A : B, freeze([A, B])];
    if (questionId === "ga032") return [L("64条の9"), A];
    if (questionId === "ga033") return [L("27条"), A];
