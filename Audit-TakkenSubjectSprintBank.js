...
const baseQuestions = { ...window.TAKKEN_EXAM_QUESTIONS, ...restrictionsSupplement.QUESTIONS_BY_ID, ...restrictionsAuthored.QUESTIONS_BY_ID };
...
assert.deepEqual(bank.COVERAGE.bySection, { taxOther: 6, restrictions: 112, rights: 44, other: 12 }, "all approved sources by subject");
assert.deepEqual(bank.COVERAGE.byFormat, { "個数問題": 27, "単一選択": 141, "組合せ問題": 6 }, "mixed formats are retained from approved sources");
...
console.log("Takken Subject Sprint Bank audit passed: 174 approved sources / tax6 law112 rights44 other12 / 696 traced facts / source-anchor separation 2.");
