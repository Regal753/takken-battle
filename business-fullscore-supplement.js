  ...
  const rawAnchors = [
    ...
    },
    {
      ...
      statements: [
        ...
        "弁済業務保証金が還付されたとき、保証協会は還付に係る通知書の送付を受けた日から2週間以内に供託を補充し、社員は保証協会の通知を受けた日から2週間以内に還付充当金を納付する。",
      ...
      reasons: [
        ...
        "保証協会の補充期限は法64条の8第3項・保証協会弁済業務保証金規則1条により通知書の送付を受けた日から2週間、社員等の還付充当金納付期限は法64条の10第2項により保証協会の通知を受けた日から2週間である。",
        "法64条の15により、社員の地位喪失後の営業保証金供託は1週間以内である。"
      ],
      sourceUrl: "https://laws.e-gov.go.jp/law/327AC1000000176",
      sourceLocator: "宅地建物取引業法64条の8第2項・3項、64条の9、64条の10第2項、64条の15／同法施行令7条／保証協会弁済業務保証金規則1条",
      verifiedAt: VERIFIED_AT,
